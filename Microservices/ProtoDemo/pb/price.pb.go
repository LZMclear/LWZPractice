...
type Price struct {
	...
	SalePrice   float32 `protobuf:"fixed32,2,opt,name=sale_price,json=salePrice,proto3" json:"sale_price,omitempty"`
}
...
func (x *Price) GetSalePrice() float32 {
	if x != nil {
		return x.SalePrice
	}
	return 0
...
var file_book_price_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x09, 0x73, 0x61, 0x6c, 0x65, 0x50, 0x72,
	0x69, 0x63, 0x65, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
func file_book_price_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_book_price_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Price); i {
			case 0:
				return &v.state
			case 1:
