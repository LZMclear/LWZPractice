...
type BookServiceClient interface {
	...
	// 获取书籍
	Get(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*GetBookRequest, error)
}
...
func (c *bookServiceClient) Get(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*GetBookRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BookServiceServer interface {
	...
	// 获取书籍
	Get(context.Context, *GetBookRequest) (*GetBookRequest, error)
...
func (UnimplementedBookServiceServer) Get(context.Context, *GetBookRequest) (*GetBookRequest, error) {
